...
allowedColors = [globalColors.VOID, globalColors.RED, globalColors.GREEN, globalColors.BLUE, globalColors.YELLOW, globalColors.MAGENTA, globalColors.CYAN, globalColors.WHITE, globalColors.ANY];
...
function Update() {
	...
	//show_debug_message([color, allowedColors[color]]);
}
